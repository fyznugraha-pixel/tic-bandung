          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
            {SUBSECTORS.map((sector, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-white aspect-square rounded-2xl flex flex-col items-center justify-center p-4 text-center border border-[#d3c5af]/50 hover:border-[#C9971E] hover:shadow-[0_8px_30px_rgba(201,151,30,0.15)] transition-all duration-300 group cursor-default"
                >
