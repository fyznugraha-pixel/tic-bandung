...
export default function EventSubmissionForm() {
  ...
  if (isSuccess) {
    return (
      <div className="bg-slate-800/80 backdrop-blur-xl rounded-2xl p-10 border border-slate-700 shadow-2xl text-center flex flex-col items-center animate-in fade-in zoom-in duration-500">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-700 border-dashed hover:border-amber-500/50 transition-colors">
            ...
            <p className="text-xs text-slate-400 mb-4">Maks 10MB (PDF/Image)</p>
            <div className="relative">
              <input type="file" name="proposal_file" required accept=".pdf,image/*" className="w-full text-sm text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-amber-500/10 file:text-amber-500 hover:file:bg-amber-500/20 cursor-pointer" />
            </div>
          </div>
          ...
          <div className="bg-slate-900/30 p-5 rounded-xl border border-slate-700 border-dashed hover:border-amber-500/50 transition-colors">
            ...
            <p className="text-xs text-slate-400 mb-4">Maks 10MB (PDF/Image)</p>
            <div className="relative">
              <input type="file" name="commitment_file" required accept=".pdf,image/*" className="w-full text-sm text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-emerald-500/10 file:text-emerald-500 hover:file:bg-emerald-500/20 cursor-pointer" />
            </div>
          </div>
        </div>
      </div>
