...
const pageMappings = [
    ...
    { title: 'Jalan Braga', folder: 'Tourist village/The village of braga' } // Replaced because Walking Tour/Jalan Braga doesn't exist
];
...
pageMappings.forEach(m => {
    ...
    if (imgUrl) {
        ...
        console.warn('NOT FOUND PAGE:', m.folder);
    }
});

const quickAccessMappings = [
    { span: 'Destinasi', folder: 'Nature Destination/Curug Dago' },
    { span: 'Kuliner', folder: 'Legendary Cullinary tourism in Bandung/Braga permai' },
    { span: 'Event', folder: 'Actractions  & arts tourism/Saung angklung Udjo' },
    { span: 'Trip Planner', folder: 'Nature Destination/Kampoeng tjibarani' },
    { span: 'Transportasi', folder: 'Tourist village/The village of braga' }
];
...
const bentoMappings = [
    ...
    { href: '/kategori/wisata-ekonomi-kreatif', folder: 'Tourist village/The knitwear of Binong jati' },
    { href: '/kategori/wisata-alam', folder: 'Nature Destination/Curug Dago' },
    { href: '/kategori/wisata-buatan', folder: 'Leisure destination/Trans studio Bandung' },
    { href: '/kategori/taman-kota', folder: 'Park Destination/Taman vanda' },
    { href: '/kategori/kampung-wisata-kreatif', folder: 'Tourist village/Creative tourism village Cibaduyut' },
    { href: '/kategori/public-space', folder: 'Park Destination/Alun alun bandung' },
    { href: '/kategori/walking-tour', folder: 'Walking Tour/Bandung good guide' },
    { href: '/kategori/atraksi-kesenian', folder: 'Actractions  & arts tourism/Saung angklung Udjo' },
    { href: '/kategori/kuliner-legendaris', folder: 'Legendary Cullinary tourism in Bandung/Rasa bakery cafe (JL Tamblong)' },
    { href: '/kategori/belanja-souvenir', folder: 'Tourist village/Creative tourism village Cibaduyut' },
...
console.log('Fixed broken images globally with REAL folders!');
