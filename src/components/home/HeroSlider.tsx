...
export default function HeroSlider({ sliders }: { sliders: SliderData[] }) {
  ...
  return (
    <header className="relative w-full h-[55vh] min-h-[380px] md:h-[80vh] md:min-h-[600px] overflow-hidden bg-gray-900">
      ...
      <div className="relative z-20 w-full h-full max-w-[1600px] px-4 md:px-8 lg:px-12 mx-auto flex flex-col justify-center">
        ...
        <div className="absolute bottom-20 md:bottom-32 left-4 md:left-12 flex gap-3">
          {sliders.map((_, index) => (
            <button
              key={index}
