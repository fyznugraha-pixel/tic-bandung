...
export default function CoECountdownBanner() {
  ...
  return (
    <section className="w-[calc(100%-2rem)] md:w-[calc(100%-4rem)] bg-white relative overflow-hidden py-8 md:py-10 border border-slate-100 rounded-sm md:rounded-sm shadow-2xl max-w-[1400px] mx-auto -mt-16 md:-mt-24 z-40">
      {/* Background elements */}
